...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		*/
		...
		//$data['getCategories'] = $this -> model_account_customer -> getCategories(0);
           ...
           foreach ($getSubcategory as $values) {
               ...
               ?>
                ...
                <li class="dropdown  dropdown-submenu">
                    ...
                    <a href="?route=account/product/product_category&categories=<?php echo $values['simple_blog_category_id'] ?>" itemprop="url" class="overflow-hidden-nowrap">
                    
                    <?php echo $values['name'] ?> (<?php echo $this -> count_product($values['simple_blog_category_id'])  ?>)
