...
class ControllerAccountForgotten extends Controller {
	...
	public function resetPasswdTran(){
		if ($this -> customer -> isLogged() && $this -> request -> get['id']) {
			...
			$subject = sprintf('Fundbtc - New transaction Password', html_entity_decode($this->config->get('config_name'), ENT_QUOTES, 'UTF-8'));

			$message  = sprintf('A new transaction password was requested from Fundbtc', html_entity_decode($this->config->get('config_name'), ENT_QUOTES, 'UTF-8')) . "\n\n";
