...
<section class="backgroud enter backgroud-1">
   <div class="wrap-form text-center">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6">
            <label class="username icon" for="username">Tên đăng nhập</label>
            
            <input placeholder="Tên đăng nhập" class="form-control c-square c-theme" name="username" id="username" value="" data-link="<?php echo $actionCheckUser; ?>">
        ...
        <div class="col-md-6">
            <label class="username icon" for="fullname">Số CMND</label>
              <input placeholder="Số CMND" class="form-control c-square c-theme" name="cmnd" id="cmnd" data-link="<?php echo $actionCheckCmnd; ?>">
      ...
      <div class="row">
        <div class="col-sm-6">
          <label class="email icon" for="emailaddress">Số điện thoại</label>
              <input placeholder="Số điện thoại" name="telephone" class="form-control c-square c-theme"  id="phone" data-link="<?php echo $actionCheckPhone; ?>">
            <span id="phone-error" class="field-validation-error" style="display: none;">
               <span>Please enter Phone Number</span>
            </span>
        </div>
        <div class="col-md-6">
          <label class="password icon" for="username">Mật khẩu</label>
                <input placeholder="Mật khẩu" class="form-control c-square c-theme"  id="password" name="password" type="password">
      ...
      <div class="row">
        <div class="col-sm-6">
            <label class="email icon" for="emailaddress">Địa chỉ email</label>
              <input class="form-control c-square c-theme" placeholder="Địa chỉ email" name="email" id="email" data-link="<?php echo $actionCheckEmail; ?>">
            <span id="email-error" class="field-validation-error" style="display: none;">
               <span id="Email-error">Please enter Email Address</span>
            </span>
        </div>
        <div class="col-sm-6">
          <label class="" for="username">Nhập lại mật khẩu</label>  
              <input placeholder="Nhập lại mật khẩu" class="form-control c-square c-theme"  id="confirmpassword" type="password">
      ...
      <div class="col-md-12 text-center" style="margin-top: 30px;">
          <div class="morph-button morph-button-modal morph-button-modal-1 morph-button-fixed">
              <button type="submit" class="btn-blueberry btn-submit">Đăng ký tài khoản</button>
