...
Store.Listing.categoryFilter = (function () {
    ...
    function getResults() {
        ...
        var request = {
            ...
            deal_min_price_eur: getQueryStringValue('deal_min_price_eur'),
            deal_max_price_eur: getQueryStringValue('deal_max_price_eur'),
            deal_min_price_one: getQueryStringValue('deal_min_price_one'),
            deal_max_price_one: getQueryStringValue('deal_max_price_one'),
            deal_business_type: getQueryStringValue('deal_business_type[]'),
            deal_delivery_method: getQueryStringValue('deal_delivery_method[]')
        };
