...
<div class="container-fluid">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title">Nhân viên</h3><a href="index.php?route=pd/nhanvien/create&token=<?php echo $_GET['token']?>"><button class="btn btn-success pull-right" style="margin-top: -5px;"><i class="fa fa-plus" aria-hidden="true"></i> Thêm Nhân viên</button></a>
    </div>
      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody id="list">
          ...
          <tr>
            ...
            <td><?php echo $seft -> getAge(date('Y-m-d',strtotime($value['date_birthday'])));?> </td>
            <td><?php echo date('d/m/Y',strtotime($value['ngaylam'])) ?></td>
            <!-- <td><?php echo $value['songaylam'];?></td> -->
            <td><?php echo $value['congviec'];?></td>
            <td class="text-center">
               <a href="index.php?route=pd/nhanvien/edit&id=<?php echo $value['id']?>&token=<?php echo $_GET['token'];?>">
                  <button class="btn btn-success"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
               </a>
               <a onclick="return confirm('Bạn có chắc chắn không?')" href="index.php?route=pd/nhanvien/submit_remove&id=<?php echo $value['id']?>&token=<?php echo $_GET['token'];?>">
